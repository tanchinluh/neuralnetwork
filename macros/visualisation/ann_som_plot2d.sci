function ann_som_plot2d(w,d,nd)
...
//
// Description
//    This is the function to visualize 2-D Self-Organizing Map
//    
// Examples
//    N = [5,5];
//    y = ann_som_hextop(N);
...
if(R < 3)
  w = [w zeros(S,3-R)];
elseif R > 2
  disp('Warning - ann_som_plot2d only shows first two dimensions.');
  w = w(:,1:2);
end 
